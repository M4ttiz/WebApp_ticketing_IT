              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select value={form.status} onChange={e => update('status', e.target.value)} className={ui.select}>
                  ...
                  <div>
                    ...
                    <input value={form.brand} onChange={e => update('brand', e.target.value)} className={ui.input} placeholder="Es. Dell" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Modello</label>
                    <input value={form.model} onChange={e => update('model', e.target.value)} className={ui.input} placeholder="Es. XPS 13 9310" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Numero seriale</label>
                    <input value={form.serialNumber} onChange={e => update('serialNumber', e.target.value)} className={ui.input} placeholder="SN123456789" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Asset Tag</label>
                    <input value={form.assetTag} onChange={e => update('assetTag', e.target.value)} className={ui.input} placeholder="IT-00123" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Sede / Ubicazione</label>
                    <input value={form.location} onChange={e => update('location', e.target.value)} className={ui.input} placeholder="Sede Milano, Piano 2" />
                  </div>
                  ...
                  <div>
                    ...
                    <input type="date" value={form.purchaseDate} onChange={e => update('purchaseDate', e.target.value)} className={ui.input} />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Scadenza garanzia</label>
                    <input type="date" value={form.warrantyExpiry} onChange={e => update('warrantyExpiry', e.target.value)} className={ui.input} />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Indirizzo IP</label>
                    <input value={form.ipAddress} onChange={e => update('ipAddress', e.target.value)} className={ui.input} placeholder="192.168.1.100" />
                  </div>

                  <div>
                    <label className="block text-sm font-medium text-slate-300 mb-1">Indirizzo MAC</label>
                    <input value={form.macAddress} onChange={e => update('macAddress', e.target.value)} className={ui.input} placeholder="00:1A:2B:3C:4D:5E" />
                  </div>

                  <div className="sm:col-span-2">
                    <label className="block text-sm font-medium text-slate-300 mb-1">Sistema operativo</label>
                    <input value={form.osVersion} onChange={e => update('osVersion', e.target.value)} className={ui.input} placeholder="Windows 11 Pro 23H2" />
                  </div>
