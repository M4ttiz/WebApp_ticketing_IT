  ...
  return (
    <div className="space-y-7">
      <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight text-text-primary">Lista Ticket</h1>
          <p className={ui.subtleText}>Cerca, filtra e gestisci i ticket</p>
        </div>
        {showNewTicket && (
          <Link
            to="/tickets/new"
            className="inline-flex items-center gap-2 rounded-ds bg-accent px-4 py-2 text-[13px] font-medium text-white transition-colors duration-150 hover:bg-accent-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/40 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-main"
          >
        ...
        {statusPills.map((o) => {
          ...
          return (
            <button
              ...
              className={cn(
                'rounded-full border px-3 py-1.5 text-[11px] font-medium transition-colors duration-150',
                active
